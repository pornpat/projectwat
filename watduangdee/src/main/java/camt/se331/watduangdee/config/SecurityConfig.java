...
import camt.se331.watduangdee.config.security.AuthenticationTokenProcessingFilter;
import camt.se331.watduangdee.config.security.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/watduangdee/**").access("hasRole('user')")
                .and()
